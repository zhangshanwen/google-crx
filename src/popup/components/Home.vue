        ...
        <el-tabs type="border-card" v-model="activeName">
            <el-tab-pane label="语句检测" name="wordsCheck">
                <el-form>
                    ...
                    <h2> {{package_name}}</h2>
                    <el-table v-show="typeValue==='key_word' &&filedValue!=='full_desc'"
                    ...
                    <el-table v-show="typeValue==='violate_word'"
            ...
            <el-tab-pane label="完整说明预览" name="fullDescPreview">
                <el-form>
                    <el-form-item prop="full_description">
                        <el-button type="primary" :loading="form.loading" @click="loadDesc()">预览</el-button>

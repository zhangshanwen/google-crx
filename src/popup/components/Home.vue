  ...
  <div class="container">
    ...
    <el-tabs type="border-card" v-model="activeName">
      ...
      <el-tab-pane label="移动端预览" name="previewMobile">
        <el-form>
          <el-form-item prop="full_description">
            <el-button type="primary" @click="loadMobileShow()"
              >预览
            </el-button>
          </el-form-item>
          <div v-if="mobileForm.show" class="mobile">
            ...
            <div class="section">
              <div class="rate-entry">
                <h3 class="value-label fff">4.8</h3>
                <i class="star label-icon black-star"></i>
            ...
            <swiper class="slideGallery" v-swiper:mySwiper="swiperOption">
              <swiper-slide v-if="mobileForm.video !== ''">
                <el-image
                  class="videoCut"
                  :src="mobileForm.videoCut"
                ></el-image>
              </swiper-slide>
              <swiper-slide v-for="image in mobileForm.bannerList">
  ...
  data() {
    return {
      ...
      mobileForm: {
        ...
        video: "",
        videoCut:
          "https://play-lh.googleusercontent.com/TogDHYop4cjomtZe-qxk7TLqnb_tigjpnUTPbDDoCgZUD9P2DG8DqLW7kiLCXvK3nNg=h2133",
        bannerList: [
